...
export default function ResellerComplaintsPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      const [eligibleRes, complaintsRes] = await Promise.all([
        api.get('/reseller/complaints/eligible-orders'),
        api.get('/reseller/complaints'),
      ]);
  ...
  const submitComplaint = async () => {
    ...
    setSuccess('');
    try {
      await api.post('/reseller/complaints', {
