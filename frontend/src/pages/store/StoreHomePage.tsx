        ...
        <>
          ...
          <section className="relative py-16 lg:py-24 overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto px-4 text-center relative z-10">
              ...
              <Button size="lg" onClick={() => setActiveTab('services')}>Buy Data Now</Button>
      ...
      {activeTab === 'faq' && (
        ...
        <section className="py-16">
          ...
          <div className="max-w-3xl mx-auto px-4">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-center text-white mb-10">Frequently Asked Questions</h2>

            <div className="space-y-3">

              {faqs.map((faq, i) => (

                <div key={i} className="bg-navy-card/60 backdrop-blur-sm border border-navy-border rounded-2xl overflow-hidden hover:border-gold/30 transition-all duration-300">
                  ...
                  >
                    ...
                    <ChevronDown className={`w-5 h-5 text-gold shrink-0 transition ${openFaq === i ? 'rotate-180' : ''}`} />

                  </button>

                  {openFaq === i && <div className="px-4 pb-4 text-sm text-gray-400">{faq.answer}</div>}
