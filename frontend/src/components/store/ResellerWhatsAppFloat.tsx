...
export default function ResellerWhatsAppFloat({ whatsapp, storeName }: ResellerWhatsAppFloatProps) {
  ...
  return (
    ...
    >
      ...
      <span className="relative flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg shadow-[#25D366]/30 hover:bg-[#20bd5a] transition-all">
